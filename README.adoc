= Couchbase Operational Insights Node.js SDK Documentation

This repository hosts the documentation source for the
https://docs.couchbase.com/operational-insights-nodejs-sdk/1.0/hello-world/overview.html[Operational Insights Node.js SDK Documentation].


This branch documents the 1.0 release of the SDK.
It follows the https://docs.couchbase.com/operational-insights-nodejs-sdk/1.0/project-docs/compatibility.html#api-version[SDK 1.0 API].
...
The [Operational Insights Enterprise repo] will also be needed for most practical purposes.
...
| `server_version:`
| SDK dotminor releases contain new APIs to match new Enterprise Analytics releases.
...
| `name-sdk:` | Allows us to name the SDK within shared content (*Node.js Analytics SDK*).
